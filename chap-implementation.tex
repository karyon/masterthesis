...
\todo[color=yellow]{implement 16 dispatches instead of 16 work groups in z dimension. benefit might be cache usage, since all work groups access the same VPLs and the same ISMs.}
\todo[color=yellow]{investigate into interleaving via shared memory in 2x2 groups}
\todo{write hedman, how did they do the 8x8 interleaving?}
...
\todo[color=green]{distinction between own work and previous work}
