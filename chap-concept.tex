...
In this chapter, the presented global illumination system is explained on a conceptual level. After giving an overview of the rendering pipeline in the next section, the chosen approaches for the different components required for global illumination are outlined. Implementation details are deferred to the next chapter.
...
\todo{bilateral vs geometry-aware}
